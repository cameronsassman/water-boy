...
export default function TeamRegistration() {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      // Prepare team data for API - let the service handle player ID generation
      const teamData = {
        ...
        players: data.players.map(player => ({
          ...
          // id and teamId should be generated by the service
        }))
      };

      // Use type assertion to bypass TypeScript checking since the service should handle this
      await teamService.createTeam(teamData as any);
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input 
                        ...
                        onChange={(e) => {
                          field.onChange(e);
                          // Clear any existing school name errors when user types
                          if (form.formState.errors.schoolName) {
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center justify-between'>
                <span>Players ({players.length}/13)</span>
                <Button 
                  type="button" 
                  onClick={addPlayer} 
